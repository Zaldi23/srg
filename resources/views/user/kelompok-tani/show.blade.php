                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-info">
                                    <div class="card-header">
                                        <h3 class="card-title">List petani dari kelompok tani {{$kelompokTani->keterangan}}, Kecatamatan {{$kelompokTani->desa->kecamatan->nama_kecamatan}}, Desa {{$kelompokTani->desa->nama_desa}}</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
